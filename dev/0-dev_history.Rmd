...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Exercice R Niveau 3 - Shiny",
    ...
    `Authors@R` = c(
      person("John", "Doe", email = "john@email.me", role = c("aut", "cre"))
    )
  )
)
...
# Put data in the package

```{r, eval=FALSE}
usethis::use_data_raw("pays")
# usethis::use_r("pays")
# checkhelper::use_data_doc(name = "pays", description = "Liste des pays ainsi que des codes ISO 3166-1 associés")
checkhelper::fix_dataset_doc(name = "pays", description = "Liste des pays ainsi que des codes ISO 3166-1 associés", overwrite = TRUE)
attachment::att_amend_desc()
# To put raw data for users
dir.create("inst")
